    ...
    return Padding(
      ...
      child: BlocBuilder<DetailsCubit, int>(
        builder: (context, quantity) {
          ...
          int totalPrice =
              context.read<DetailsCubit>().calculateTotalPrice(unitPrice);
          return Column(
            children: [
              Text(
              ...
              Image.network(
                'http://kasimadalan.pe.hu/yemekler/resimler/${widget.foodModel.yemek_resim_adi}',
                height: MediaQuery.of(context).size.height * 0.4,
              ),
              const DetailsDescription(),
              DetailsPriceText(
                priteText: "$totalPrice",
              ),
              const DetailsStack(),
              Padding(
                ...
                child: Row(
                  children: [
                    ...
                    Container(
                        ...
                        child: QuantitiyIconbutton(
                            iconColor: Colors.white,
                            iconData: Icons.add,
                            onPressed: () {
                              context
                                  .read<DetailsCubit>()
                                  .incrementQuantity(unitPrice);
                    ...
                    Container(
                        ...
                        child: QuantitiyIconbutton(
                            ...
                            onPressed: () {
                              ...
                              context.read<FoodBadgeCubit>().removeBadgeItems();
                              },
                            ),
                        )
                  ],
