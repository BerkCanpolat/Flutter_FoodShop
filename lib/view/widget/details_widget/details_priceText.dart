  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: Row(
        ...
        text: '${context.detailsPriceTwo} ', style: Theme.of(context).textTheme.titleMedium?.copyWith(
          
          fontWeight: FontWeight.bold
        ),
        children: <TextSpan>[
          TextSpan(text: '${context.detailsPriceOne} ₺' ,style:  Theme.of(context).textTheme.titleMedium?.copyWith(
